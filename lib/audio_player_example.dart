...
class AudioPlayerExample extends StatefulWidget {
  ...
  @override
  State<AudioPlayerExample> createState() => _SimpleExampleAppState();
}

class _SimpleExampleAppState extends State<AudioPlayerExample> {
  ...
  void addMusic() async {
    ...
    await player.setSource(DeviceFileSource(result.paths.first!));
    await player.resume();
  }
